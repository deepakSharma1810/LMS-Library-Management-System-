          ...
          <div className="w-full px-4">
            ...
            <div className="relative w-full px-6 sm:px-8">
              ...
              <button
                ...
                className="absolute left-0 top-1/2 -translate-y-1/2 z-20 w-9 h-9 rounded-full bg-[#162428]/95 border border-amber-300/20 text-amber-300 flex items-center justify-center shadow-lg hover:bg-amber-300 hover:text-[#122125] transition-all duration-200 -translate-x-1/2 -pointer"
              >
              ...
              <div
                ref={carouselRef}
                className="mx-auto w-full max-w-[1400px] flex gap-5 px-2 overflow-x-auto scroll-smooth snap-x snap-mandatory scrollbar-hide"
              >
                {previousBooks?.map((book) => (
                  <div
                    key={book._id}
                    className="book-card flex-shrink-0 snap-start w-full sm:w-[calc(50%-6px)] lg:w-[calc(33.333%-8px)]"
                  >
                    <div className="h-full bg-[#122125] border border-white/5 hover:border-amber-300/20 rounded-xl overflow-hidden shadow-lg hover:shadow-amber-300/10 transition-all duration-300 group">
                      <Link to={`/book/${book._id}`}>
                        <div className="relative overflow-hidden">
                          <img
                            src={book.coverPhoto}
                            alt={book.name}
                            className="w-full h-44 sm:h-48 md:h-52 lg:h-56 object-cover group-hover:scale-105 transition-transform duration-300"
                          />
                        </div>

                        <div className="px-3 py-3 flex flex-col gap-1.5">
                          <div className="flex justify-between items-start gap-2">
                            <p className="text-sm font-semibold text-amber-50 line-clamp-2 leading-snug group-hover:text-amber-300">
                              {book.name}
                            </p>

                            <span className="shrink-0 text-xs font-bold text-amber-300 bg-amber-300/10 px-2 py-0.5 rounded-full">
                              ₹{book.price}
                            </span>
                          </div>
              ...
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 z-20 w-9 h-9 rounded-full bg-[#162428]/95 border border-amber-300/20 text-amber-300 flex items-center justify-center shadow-lg hover:bg-amber-300 hover:text-[#122125] transition-all duration-200 translate-x-1/2 cursor-pointer"
              >
